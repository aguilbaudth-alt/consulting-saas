...
export const TESTIMONIALS: Testimonial[] = [
  ...
  },
  {
    ...
    quote: {
      en: "LEANOVEX was a very effective partner, showing great skill and professional rigor on every topic they managed. Trust and professionalism are two qualities I valued highly in working with them. I strongly recommend LEANOVEX's services.",
      fr: "LEANOVEX s'est révélé un partenaire très efficace, faisant preuve de grandes compétences et d'une rigueur professionnelle sur chaque sujet traité. La confiance et le professionnalisme sont deux qualités que j'ai particulièrement appréciées. Je recommande vivement les services de LEANOVEX.",
    },
  },
];
